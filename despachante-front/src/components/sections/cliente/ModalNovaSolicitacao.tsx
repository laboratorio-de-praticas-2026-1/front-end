      ...
      <DialogContent className="sm:max-w-md md:max-w-lg lg:max-w-xl bg-white">
        ...
        <div className="flex flex-col gap-5 py-4">
          <div className="flex flex-col gap-2">
            ...
            <Select value={veiculoSelecionado} onValueChange={setVeiculoSelecionado}>
              <SelectTrigger 
                id="veiculo" 
                className="w-full bg-white border-gray-300 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none"
              >
        ...
        <DialogFooter className="flex flex-col-reverse sm:flex-row gap-2">
          <Button 
            ...
            className="w-full sm:w-auto bg-white hover:bg-gray-100 focus:ring-2 focus:ring-blue-500"
          >
            Cancelar
          </Button>
          <Button 
            onClick={handleSave} 
            className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white focus:ring-2 focus:ring-blue-500"
          >
            Salvar
          </Button>
        </DialogFooter>
