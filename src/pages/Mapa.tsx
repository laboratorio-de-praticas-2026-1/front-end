...
import LocationDetail from "@/components/sections/mapa/LocationDetail";
...
const LOCAIS_MOCK: Local[] = [
  {
    ...
    imagens: [
      "https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?q=80&w=400&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?q=80&w=400&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1538108149393-cebb47ac196e?q=80&w=400&auto=format&fit=crop",
    ],
    lat: -24.4925,
    lng: -47.8441,
    categoria: "Clínicas",
    website: "irssl.org.br",
    telefone: "(13) 3500-8945",
  ...
  },
  {
    ...
    lng: -47.8402,
    categoria: "Clínicas",
    website: "cliniprev.com.br",
    telefone: "(13) 3821-1234",
    email: "contato@cliniprev.com.br",
    acessivel: true,
  },
  {
    id: 3,
    ...
    lng: -47.8354,
    categoria: "Clínicas",
    telefone: "(13) 3821-3795",
    email: "cedimar@cedimar.com.br",
  },
  {
    id: 4,
    ...
    lng: -47.8430,
    categoria: "Clínicas",
    website: "saudevida.com.br",
    telefone: "(13) 3822-5678",
  ...
  },
  {
    ...
    telefone: "(13) 3823-9900",
    email: "agenda@odontoprime.com.br",
  },
  {
    id: 6,
    ...
    lng: -47.8420,
    categoria: "Clínicas",
    telefone: "(13) 3821-0001",
    email: "lab.saojoao@email.com",
    acessivel: true,
  },
  {
    id: 7,
    ...
    imagens: [
      "https://images.unsplash.com/photo-1632823471565-3cefc4ee52b1?q=80&w=400&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1486495146683-774b706c9bc3?q=80&w=400&auto=format&fit=crop",
    ],
    lat: -24.4900,
    lng: -47.8420,
    categoria: "Vistoria",
    website: "vistoriafacil.com.br",
    telefone: "(13) 3824-1111",
    email: "contato@vistoriafacil.com.br",
  },
  {
    id: 8,
    ...
    imagens: [
      "https://images.unsplash.com/photo-1486495146683-774b706c9bc3?q=80&w=400&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1503328427499-d92d1fa3ca6c?q=80&w=400&auto=format&fit=crop",
    ],
    lat: -24.4870,
    lng: -47.8460,
    categoria: "Vistoria",
    website: "supervisitoias.com.br",
    telefone: "(13) 3825-2222",
    email: "supervisao@email.com",
    acessivel: true,
  },
  {
    id: 9,
    ...
    imagens: [
      "https://images.unsplash.com/photo-1613214149922-f1809c99b414?q=80&w=400&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1632823471565-3cefc4ee52b1?q=80&w=400&auto=format&fit=crop",
    ],
    lat: -24.4800,
    lng: -47.8300,
    categoria: "Vistoria",
    website: "dekra.com.br",
    telefone: "(13) 3826-3333",
    email: "registro@dekra.com.br",
  },
  {
    id: 10,
    ...
    lng: -47.8385,
    categoria: "Vistoria",
    telefone: "(13) 3827-4444",
    email: "vistoria100@email.com",
  },
  {
    id: 11,
    ...
    imagens: [
      "https://images.unsplash.com/photo-1577412647305-991150c7d163?q=80&w=400&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=400&auto=format&fit=crop",
    ],
    lat: -24.4855,
    lng: -47.8322,
    categoria: "Detran",
    website: "poupatempo.sp.gov.br",
    telefone: "0800 772 3102",
    email: "poupatempo@sp.gov.br",
    acessivel: true,
  },
  {
    id: 12,
    ...
    lng: -47.8480,
    categoria: "Detran",
    website: "detran.sp.gov.br",
    telefone: "(13) 3821-0000",
    email: "ciretran.registro@detran.sp.gov.br",
    acessivel: true,
  },
  {
    id: 13,
    ...
    imagens: [
      "https://images.unsplash.com/photo-1556155092-490a1ba16284?q=80&w=400&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?q=80&w=400&auto=format&fit=crop",
    ],
    lat: -24.4888,
    lng: -47.8455,
    categoria: "Detran",
    telefone: "(13) 3822-7777",
    email: "despachanteribeira@email.com",
  },
  {
    id: 14,
    ...
    lng: -47.8475,
    categoria: "Detran",
    website: "despachanteexpresso.com.br",
    telefone: "(13) 3823-8888",
    email: "expresso@email.com",
    acessivel: true,
  },
];
...
export default function Mapa() {
  ...
  const [selectedDetail, setSelectedDetail] = useState<Local | null>(null);

  const locaisFiltrados = activeFilter
    ? LOCAIS_MOCK.filter((local) => local.categoria === activeFilter)
    : LOCAIS_MOCK;

  const [activeLocation, setActiveLocation] = useState<Local>(
    locaisFiltrados[0] || LOCAIS_MOCK[0]
  );
  ...
  const handleLocationSelect = (local: Local) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#F3F4F6] font-sans">
      ...
      <main className="flex-1 flex flex-col w-full max-w-[1600px] mx-auto px-6 py-6 overflow-hidden">
        <MapSearch activeFilter={activeFilter} onFilterChange={setActiveFilter} />
